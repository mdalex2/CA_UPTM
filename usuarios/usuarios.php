...
<div id="page" class="shell">
	...
	<tr>
	   <td >
		<h2>Módulo Seguridad / usuarios ('.$accion.')</h2>
	  </td>
	  <td width="30px"></td>
	  <td>
	  &nbsp;<a id="resize" href="usuarios.php?accion=nuevo" class="boton" style="font-size:10px;padding:2px; color:#000000;" width="45%" height="90%" title="Crear nuevo" >&nbsp;
                  <img src="../images/icons_menu/x32/vcard_add.png" width="20px" heigth="20px" align="absmiddle"></img>&nbsp;Nuevo&nbsp;
              </a> 
	  </td>	
	  <td>
	  &nbsp;<a id="resize" href="usuarios.php?accion=buscar" class="boton" style="font-size:10px;padding:2px; color:#000000;" width="45%" height="90%" title="Buscar" >&nbsp;
