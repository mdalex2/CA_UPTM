...
<table width="100%" border="0">
  <tr>
    <td align="center"><span class="titulo">REPORTE DE LISTADO DE PERSONAL</span><strong><span class="titulo"></span></strong></td>
  </tr>
</table>
<table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#000000" style="border-collapse: collapse;font-weight: normal; text-transform:uppercase;" class="margenes">
  ...
  $sql="select Cedula,Nombre,Apellido,Telefono,cargo from personal";
  $db=conectarse();
  ...
  ?>
  <tr>
    <td scope="col"><?php echo  $cedula=$fila["Cedula"];?></td>
    <td scope="col"><?php echo  $cedula=$fila["Nombre"];?></td>
    <td scope="col"><?php echo  $cedula=$fila["Apellido"];?></td>
    <td scope="col"><?php echo  $cedula=$fila["cargo"];?></td>
    <td scope="col"><?php echo  $cedula=$fila["Telefono"];?></td>
  </tr>
  <?php
  } // fin while
