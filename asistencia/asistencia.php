...
<div id="page" class="shell">
	...
	<tr>
	   <td >
		<h2>Módulo registro de asistencia ('.$accion.')</h2>
	  </td>
	  <td width="30px"></td>
	  <td>
	  &nbsp;<a id="resize" href="asistencia.php?accion=listado_inasistencia" class="boton" style="font-size:10px;padding:2px; color:#000000;" width="45%" height="90%" title="Buscar" >&nbsp;
                  <img src="../images/icons_menu/x32/find_x32.png" width="20px" heigth="20px" align="absmiddle"></img>&nbsp;Nueva busqueda&nbsp; inasistentes
              </a> 
	  </td>	
	  ...
	  &nbsp;<a id="resize" href="reporte.php" class="boton" style="font-size:10px;padding:2px; color:#000000;" width="45%" height="90%" title="Ver listado" target="_blank">&nbsp;
                  <img src="../images/icons_menu/x32/00231.png" width="20px" heigth="20px" align="absmiddle"></img>&nbsp;Listado&nbsp;general para éste mes
              </a> 
	  </td>	  
	...
	switch ($accion){
		case "entrada":
		    unset($_SESSION["msg"]);
			include_once("guardar_ent.php");
			guardar_ent();
			break;
		case "salida":
			include_once("guardar_sal.php");
			guardar_sal();
			break;
		case "reporte":
			include_once("reporte_mes.php");
			break;	
		case "listado_inasistencia":
			include_once("buscar.php");
			break;	
		case "consulta_individual":
			include_once("consulta_individual.php");
			break;	
